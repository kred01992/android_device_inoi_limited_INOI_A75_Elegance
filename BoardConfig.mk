...
# vendor_boot = ramdisk only (recovery); kernel must stay in boot partition
...
# File systems
BOARD_HAS_LARGE_FILESYSTEM := true
BOARD_RECOVERY_DEVICE_MODULES := libf2fs_utils_resizer
TARGET_USERIMAGES_USE_EXT4 := true
TARGET_USERIMAGES_USE_F2FS := true
TARGET_RECOVERY_FSTAB := device/inoi_limited/INOI_A75_Elegance/recovery.fstab

# EROFS Support
BOARD_EROFS_COMPRESSOR := lz4

# Suppress deprecated sepolicy warnings (use new variable names)
